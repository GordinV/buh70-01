...
const Vorder = React.createClass({
                ...
                <div className='div-doc'>
                    ...
                    <div className="fieldset">
                        <ul>
                            ...
                            <li>
                                <InputDate className='ui-c2' title='Kuupäev '
                                           name='kpv'
                                           value={data.kpv}
                                           ref='kpv'
                                           placeholder='Kuupäev'
                            ...
                            <li>
                                <Select className='ui-c2' title="Kassa" name='kassa_id' libs="aa"
                                        value={data.kassa_id}
                                        collId = 'id'
                            ...
                            <li>
                                <Select className='ui-c2' title="Partner"
                                        name='asutusid'
                                        libs="asutused"
                                        value={data.asutusid}
                                        collId = 'id'
                            ...
                            <li>
                                <TextArea className='ui-c2'
                                          ...
                                          value={data.aadress} readOnly={!isEditeMode} width="85%"/></li>
                            <li>
                                <TextArea className='ui-c2' title="Alus" name='alus' placeholder='Alus'
                                          ref="alus"
                                          key="textAlus"
                            ...
                            <li>
                                <InputText className='ui-c2' title="Summa: " name='summa' placeholder='Summa'
                                           ref="summa"
                                           value={data.summa} disabled='true'
                                           pattern="^[0-9]+(\.[0-9]{1,4})?$"/></li>
                            {/* патерн для цифр с 4 знаками после точки*/}
                            <li>
                                <TextArea className='ui-c2' title="Märkused" name='muud' placeholder='Märkused'
                                          ref="muud"
