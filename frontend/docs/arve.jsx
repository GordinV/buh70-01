...
var relatedDocuments = require('../mixin/relatedDocuments.jsx'),
                ...
                <div className='div-doc'>
                    ...
                    <div className="fieldset">
                        <ul>
                            ...
                            <li>
                            <InputDate className='ui-c2' title='Tähtaeg ' name='tahtaeg' value={data.tahtaeg} ref="tahtaeg"
                                       placeholder='Tähtaeg' readOnly={!isEditeMode}/>
                                </li>
                            
                            <li><Select className='ui-c2' title="Asutus" name='asutusid' libs="asutused"
                                value={data.asutusid} defaultValue={data.asutus} placeholder='Asutus' ref="asutusid"
                                readOnly={!isEditeMode}/>
                            </li>
                        <li><InputText className='ui-c2' title='Lisa ' name='lisa' value={data.lisa} placeholder='Lisa'
                                   ref='lisa' readOnly={!isEditeMode}/>
                        </li>
                        <li><TextArea className='ui-c2' title="Märkused" name='muud' placeholder='Märkused' ref="muud"
                            ...
                            <li><InputText className='ui-c2' title="Summa: " name='summa' placeholder='Summa' ref="summa"
                                   value={data.summa} disabled='true'
                                   pattern="^[0-9]+(\.[0-9]{1,4})?$"/></li> {/* патерн для цифр с 4 знаками после точки*/}
                        <li><InputText className='ui-c2' title="Käibemaks " name='kbm' placeholder='Käibemaks' ref="kbm"
                                   value={data.kbm}
                                   pattern="^[0-9]+(\.[0-9]{1,4})?$"/></li> {/* патерн для цифр с 4 знаками после точки*/}
                        </ul>
                    </div>
