    describe('Raamatupidamine tests units, models', function () {
        ...
        it('ARV select', function (done) {
            var DocDataObject = require('../models/documents');
            DocDataObject.selectDoc('ARV', [22], function (err, data) {
                if (err) throw new Error('Ошибка метода  selectDoc');
                done();
            });
        });
        ...
        it('JOURNAL save new', function (done) {
            var data = JSON.stringify(
                {   "id":0,
                    "doc_type_id":"JOURNAL",
                    "data":
                        {"id":0,"created":"2016-05-21T21:39:57.050726","lastupdate":"2016-05-21T21:39:57.050726","bpm":null,"doc":"Lausendid","doc_type_id":"JOURNAL",
            "status":"Черновик","summa":100,"rekvid":null,"kpv":"2016-05-21","asutusid":1,"dok":"lisa","selg":"selg","muud":"muud","regkood":null,"asutus":null},"details":[{"id":"NEW0.6577064044198089","deebet":"113","kreedit":"122","summa":100,"tunnus":"tunnus","proj":"proj"}]
                }),
                doc_id = 0;
        ...
        it('SORDER save new', function (done) {
            var data = JSON.stringify(
                {   "id":0,
                    "doc_type_id":"SORDER",
                    "data":
                    {"id":0,"doc_type_id":"SORDER","data":{"id":0,"tyyp":1,"kassa_id":1, "bpm":null,"doc_type_id":"SORDER","status":"Черновик","number":"1","rekvid":1,"kpv":"2016-05-31","asutusid":1,"dokument":"Arve","alus":"test","muud":"muud","summa":100,"regkood":"123456789","asutus":"isik, töötaja","nimi":"isik"},"details":[
                        {"nomid":3,"nimetus":"paNK", "id":0,"summa":"100.0000","kood1":null,"kood2":null,"kood3":null,"kood4":null,"kood5":null,"konto":"113","valuuta":"EUR","kuurs":"1.000000","tunnus":"tunnus","proj":"proj"}]}
        }),
                doc_id = 0;
        ...
        it('VORDER save new', function (done) {
            var data = JSON.stringify(
                {   "id":0,
                    "doc_type_id":"VORDER",
                    "data":
                    {"id":0,"doc_type_id":"VORDER","data":{"id":0,"tyyp":2,"kassa_id":1, "bpm":null,"doc_type_id":"VORDER","status":"Черновик","number":"1","rekvid":1,"kpv":"2016-06-16","asutusid":1,"dokument":"Arve","alus":"test","muud":"muud","summa":100,"regkood":"123456789","asutus":"isik, töötaja","nimi":"isik"},"details":[
                        {"nomid":3,"nimetus":"paNK", "id":0,"summa":"200.0000","kood1":null,"kood2":null,"kood3":null,"kood4":null,"kood5":null,"konto":"113","valuuta":"EUR","kuurs":"1.000000","tunnus":"tunnus","proj":"proj"}]}
                }),
                doc_id = 0;
